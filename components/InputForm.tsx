          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-3 py-3 bg-gray-900/50 border border-gray-700 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent text-white outline-none appearance-none cursor-pointer hover:bg-gray-800 transition-colors"
                style={{ WebkitAppearance: 'none', MozAppearance: 'none' }}
              >
                {years.map((y) => (
                  <option key={y} value={y} className="bg-gray-800 text-white">{y}년</option>
                ))}
              </select>
            ...
            <div className="relative">
              ...
              >
                {months.map((m) => (
                  <option key={m} value={m} className="bg-gray-800 text-white">{m}월</option>
                ))}
              </select>
              <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none text-gray-400">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
            ...
            <div className="relative">
              ...
              >
                {days.map((d) => (
                  <option key={d} value={d} className="bg-gray-800 text-white">{d}일</option>
                ))}
              </select>
              <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none text-gray-400">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
